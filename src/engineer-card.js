// Required HTML for generating an engineer card.
...
function generateEngineerCard (team){
    ...
    <section class="col-span-1 m-8 shadow-lg ">
            ...
            <h3 class="font-medium bg-blue-300 text-indigo-900 px-4 py-4 text-3xl">Engineer</h3>
            <ul class="bg-white p-2 text-2xl">
                ...
                <li class="font-medium text-gray-700 bg-blue-200 my-2 p-2 shadow-md border-4 border-blue-400 hover:bg-blue-100 hover:border-blue-300"><a href="https://github.com/${team.getGithub()}">Github: ${team.getGithub()}</a> </li>
            </ul>
    </section>
    `
}
